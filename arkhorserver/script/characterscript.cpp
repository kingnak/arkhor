...
bool CharacterScript::hasObject(const QString &typeId)
{
...
bool CharacterScript::removeTypeFromInventory(const QString &typeId)
{
...
QString CharacterScript::selectChoice(const QString &desc, const QString &sourceId, const QList<AH::Common::ChoiceData::OptionData> &options)
{
    return selectChoice(desc, sourceId, options, false);
}

QString CharacterScript::selectChoice(const QString &desc, const QString &sourceId, const QList<AH::Common::ChoiceData::OptionData> &options, bool canBeCanceled)
{
    return gGame->context().selectChoice(gGame->playerForCharacter(this), desc, sourceId, options, canBeCanceled);
}

QList<GameObjectScript *> CharacterScript::selectObjects(const QList<GameObjectScript *> &objects, const QString &desc, const QString &sourceId, int min, int max)
{
    ...
    for (auto o : sels) res << dynamic_cast<GameObjectScript *> (o);
    return res;
}
...
int CharacterScript::genericDieRollSum(const QString &desc, const QString &sourceId, int dieCount)
{
...
bool CharacterScript::genericDieRollTest(const QString &desc, const QString &sourceId, int dieCount, int target)
{
    int ct = genericDieRollCount(desc, sourceId, dieCount);
    return ct >= target;
}

int CharacterScript::genericDieRollCount(const QString &desc, const QString &sourceId, int dieCount)
{
...
int CharacterScript::genericDieRollCountSuccess(const QString &desc, const QString &sourceId, int dieCount, const QScriptValue &successes)
{
...
bool CharacterScript::skillTest(const QString &desc, const QString &sourceId, AH::Skill skill, int adjust, int target)
{
...
int CharacterScript::dieRollSkillCount(const QString &desc, const QString &sourceId, AH::Skill skill, int adjust)
{
